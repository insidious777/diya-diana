...
var horustime = date.getHours();
if (times < 9	&& horustime < 9) {
	$('.rf_title').text('Данi оновлено ' + date.getDate() + ' ' + arr[month] + ' 2021 о 0' + date.getHours() + ':0'  + date.getMinutes() + '');
}
else if (horustime < 9) {
	$('.rf_title').text('Данi оновлено ' + date.getDate() + ' ' + arr[month] + ' 2021 о 0' + date.getHours() + ':'  + date.getMinutes() + '');
}
else if (times < 9) {
	$('.rf_title').text('Данi оновлено ' + date.getDate() + ' ' + arr[month] + ' 2021 о ' + date.getHours() + ':0'  + date.getMinutes() + '');
}
else {
	$('.rf_title').text('Данi оновлено ' + date.getDate() + ' ' + arr[month] + ' 2021 о ' + date.getHours() + ':'  + date.getMinutes() + '');
}
